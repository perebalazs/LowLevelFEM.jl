...
gmsh.open("/home/perebal/Dokumentumok/GitHub/LowLevelFEM.jl/examples/foam2D.geo")
body = FEM.material("body", E=2e5, ν=0.3, ρ=7.85e-9)
problem = FEM.Problem([body], type="PlaneStress")
